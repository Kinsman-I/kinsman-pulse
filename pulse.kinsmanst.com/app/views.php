...
function render(string $title, callable $body, bool $guest = false): void
{
    ...
    <?php else: ?>
      ...
      <div class="app-main"><header class="topbar"> <button class="menu-toggle" type="button" aria-label="Abrir menu" aria-expanded="false" aria-controls="main-menu">
    <span></span><span></span><span></span>
  </button><div><strong><?= e($title) ?></strong><small><?= e(date('d/m/Y')) ?></small></div><div class="top-actions"><span class="avatar"><?= e(strtoupper(substr($u['name'],0,2))) ?></span><a class="button ghost" href="<?= url('logout') ?>">Sair</a></div></header>
